...
function Cryptocurrency() {
    ...
    return (
      <div className='container-fluid'>
         <h1 className='text-center mt-3 text-white'>Crypocurrency API</h1><br/>
          <form>
          ...
          <div className='row'><br/>
            {
              priceFilterCoins.map((coin) =>{
                return <CryptoDisplay display image={coin.image} name={coin.name}  id={coin.id} currentPrice={coin.current_price} lastUpdated={coin.last_updated}/>
              })
            }
         </div>
      </div>
